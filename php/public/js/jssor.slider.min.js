(function (g, e, b, j, c, i, k) {/*! Jssor */
    ...
    var a = g.$Jssor$ = new function () {
        var f = this, zb = /\S+/g, S = 1, fb = 2, jb = 3, ib = 4, nb = 5, I, s = 0, l = 0, q = 0, J = 0, C = 0, y = navigator, sb = y.appName, n = y.userAgent, v = e.documentElement;

        function Ib() {
            if (!I) {
                I = {$Touchable: "ontouchstart"in g || "createTouch"in e};
                var a;
        ...
        function t(i) {
            if (!s) {
                ...
                if (sb == "Microsoft Internet Explorer" && !!g.attachEvent && !!g.ActiveXObject) {
                    ...
                    s = S;
                    q = o(n.substring(f + 5, n.indexOf(";", f)));
        ...
        function Bb(g, a, i) {
            if (!J || J < 9) {
                ...
                if (j || d != k || e != k) {
                    if (d == k)d = 1;
                    if (e == k)e = 1;
                    var c = f.$CreateMatrix(j / 180 * b.PI, d || 1, e || 1), i = f.$GetMatrixOffset(c, a.$OriginalWidth, a.$OriginalHeight);
        ...
        f.$WindowSize = function () {
            var a = e.body;
            return {x: a.clientWidth || v.clientWidth, y: a.clientHeight || v.clientHeight}
        };
        function B(c, d, a) {
        ...
        f.$WindowResizeFilter = function (b, a) {
            return L() ? function () {
                ...
                if (d) {
                    var f = d.offsetWidth - lb, e = d.offsetHeight - gb;
                    if (f || e) {
                        lb += f;
                        gb += e
                    } else g = i
        ...
        function Gb(b) {
            var l = this, p = "", r = ["av", "pv", "ds", "dn"], g = [], q, j = 0, h = 0, d = 0;
        ...
        f.$GetMatrixOffset = function (d, c, a) {
            var e = D.$TransformPoint(d, w(-c / 2, -a / 2)), f = D.$TransformPoint(d, w(c / 2, -a / 2)), g = D.$TransformPoint(d, w(c / 2, a / 2)), h = D.$TransformPoint(d, w(-c / 2, a / 2));
        ...
        f.$FormatEasings = function (b) {
            var c = b || {};
            if (b)if (a.$IsFunction(b))c = {$Default: c}; else if (a.$IsFunction(b.$Clip))c.$Clip = {$Default: b.$Clip};
            return c
        };
        function tb(c, a) {
            var b = {};
            m(c, function (c, d) {
                var e = c;
                if (a[d] != k)if (f.$IsNumeric(c))e = c + a[d]; else e = tb(c, a[d]);
                b[d] = e
            });
            return b
        }
        ...
        f.$Cast = function (h, i, w, n, y, z, o) {
            ...
            if (h) {
                ...
                for (var g in i) {
                    ...
                    var u = b.floor(e);
                    if (e != u)e -= u;
                    var l = n.$Default || d.$EaseSwing, m, B = h[g], q = i[g];
                    if (a.$IsNumeric(q)) {
                        l = n[g] || l;
                        var x = l(e);
                        m = B + q * x
                    } else {
                        m = a.$Extend({$Offset: {}}, h[g]);
                ...
                var t, f = {$OriginalWidth: o.$OriginalWidth, $OriginalHeight: o.$OriginalHeight};
            ...
            if (i.$Clip && o.$Move) {
                var p = c.$Clip.$Offset, s = (p.$Top || 0) + (p.$Bottom || 0), r = (p.$Left || 0) + (p.$Right || 0);
                c.$Left = (c.$Left || 0) + r;
                c.$Top = (c.$Top || 0) + s;
                c.$Clip.$Left -= r;
                c.$Clip.$Right -= r;
    ...
    var l = g.$JssorAnimator$ = function (y, C, k, P, N, J) {
        y = y || 0;
        var d = this, q, M, n, o, v, z = 0, H, I, G, B, x = 0, h = 0, m = 0, D, l, s, f, e, p, w = [], A;
        ...
        function K() {
            if (q) {
                var d = a.$GetNow(), e = b.min(d - z, k.$IntervalMax), c = h + e * o;
                z = d;
                if (c * o >= n * o)c = n;
                u(c);
                if (!v && c * o >= n * o)L(B); else r(K)
            }
        }
    ...
    g.$JssorSlideshowRunner$ = function (n, s, q, t, y) {
        var f = this, u, g, e, x = 0, w = t.$TransitionsOrder, r, h = 8;
        ...
        function p(A, h, d, v, n, l) {
            var y = this, t, u = {}, j = {}, m = [], f, e, r, p = d.$ChessMode.$Column || 0, q = d.$ChessMode.$Row || 0, g = d.$GetBlocks(n, l), o = B(d), C = o.length - 1, s = d.$Duration + d.$Delay * C, w = v + s, k = d.$SlideOut, x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
                ...
                if (e || x) {
                    ...
                    a.$Each(j, function (c, e) {
                        ...
                        if (c.$LastFrameIndex != d) {
                            if (!c.$LastFrameIndex && !k)a.$ShowElement(m[e]); else d == c.$Max && k && a.$HideElement(m[e]);
                            c.$LastFrameIndex = d;
            ...
            if (a.$IsBrowserIe9Earlier()) {
                var D = !h["no-image"], z = a.$FindChildrenByTag(h);
                a.$Each(z, function (b) {
            ...
            a.$Each(o, function (h, m) {
                a.$Each(h, function (G) {
                    ...
                    if (d.$Zoom || d.$Rotate) {
                        var H = c;
                        if (a.$IsBrowserIe9Earlier())if (d.$Cols * d.$Rows > 1)H = i; else I = i;
                        if (H) {
    ...
    var h = g.$JssorSlider$ = function (q, fc) {
        ...
        function Ec() {
            ...
            a.$GetCurrentSlideInfo = function () {
                var c = a.$GetPosition_Display(), d = b.floor(c), f = t(d), e = c - b.floor(c);
        ...
        function qc(n, m) {
            var a = this, d, e, g, k, b;
            l.call(a, -1e8, 2e8, {$IntervalMax: 100});
            a.$OnStart = function () {
                O = c;
                R = j;
        ...
        function Bc(k, e) {
            var d = this, q, H, x, n, y = [], w, B, W, G, Q, F, g, v, p, eb;
            l.call(d, -u, u + 1, {$SlideItemAnimator: c});
            function E(b) {
                q && q.$Revert();
                T(k, b, 0);
                F = c;
                    ...
                    if (n && m) {
                        ...
                        if (g && b && f.$FillMode) {
                            if (f.$FillMode & 3 && (!(f.$FillMode & 4) || g > K || b > J)) {
                                var j = i, q = K / J * b / g;
                                if (f.$FillMode & 1)j = q > 1; else if (f.$FillMode & 2)j = q < 1;
                                l = j ? g * J / b : K;
                                k = j ? J : b * K / g
                            }
                            a.$CssWidth(n, l);
            ...
            function ab(b) {
                if (b == R && s == e) {
                    if (!g) {
                        var a = j;
                        if (A)if (A.$Index == e)a = A.$GetProcessor(); else A.$Clear();
                        Y();
                        g = new yc(k, e, a, q);
                        g.$SetPlayer(p)
                    }
            ...
            function S(c, h, l) {
                if (c == e) {
                    if (c != h)C[h] && C[h].$ParkOut(); else!l && g && g.$AdjustIdleOnPark();
                    p && p.$Enable();
                    var m = R = a.$GetNow();
            ...
            function T(b, d, e) {
                ...
                var f = a.$Children(b);
                a.$Each(f, function (f) {
                    var h = f.tagName, j = a.$AttributeEx(f, "u");
                    if (j == "player" && !v) {
                        v = f;
                        if (v.pInstance)O(); else a.$AddEvent(v, "dataavailable", O)
                    }
                    if (j == "caption") {
                        if (d) {
                        ...
                        if (h == "A") {
                            if (a.$AttributeEx(f, "u") == "image")n = a.$FindChildByTag(f, "IMG"); else n = a.$FindChild(f, "image", c);
                            if (n) {
                                w = f;
        ...
        function yc(y, f, p, q) {
            ...
            b.$Replay = function () {
                ...
                if (!B && !O && !r && s == f) {
                    ...
                    if (a != d)if (a == e)i = d; else if (a == j)i = e; else if (!a)i = j; else i = b.$GetPlayToPosition();
                    o.$TriggerEvent(p, f, a, m, j, e, d);
                    var l = P && (!E || F);
                    if (a == d)(e != d && !(E & 12) || l) && n.$GoForNextSlide(); else(l || a != e) && b.$PlayToPosition(i, w)
                }
            };
        ...
        function Zb(g, f) {
            var e = x > 0 ? x : gb, c = Bb * f * (e & 1), d = Cb * f * (e >> 1 & 1);
            c = b.round(c);
            d = b.round(d);
            a.$CssLeft(g, c);
            a.$CssTop(g, d)
        ...
        function ec(e) {
            if (!B && (F || !(E & 12)) && !z.$IsPlaying()) {
                ...
                var d = b.abs(a - c);
                d = 1 - b.pow(1 - d, 5);
                if (!M && pb)z.$Continue(Kb); else if (c == a) {
                    tb.$EnablePlayer();
                    tb.$TryActivate()
        ...
        function Db(e) {
            if (B) {
                ...
                if (f) {
                    ...
                    if ((j || k) && !x) {
                        if (L == 3)if (b.abs(k) > b.abs(j))x = 2; else x = 1; else x = L;
                    ...
                    if (x) {
                        ...
                        if (H && x && !Ab) {
                            a.$CancelEvent(e);
                            if (!O)z.$StandBy(sb); else z.$SetStandByPosition(sb)
                        }
                    }
                }
            }
        ...
        function nb(g, e, l) {
            if (Rb && (!B && (F || !(E & 12)) || f.$NaviQuitDrag)) {
                ...
                z.$Stop();
                if (e == k)e = Vb;
                var d = Eb.$GetPosition_Display(), a = g;
                if (l) {
                    a = d + g;
        ...
        var gb = f.$PlayOrientation & 3, wc = (f.$PlayOrientation & 4) / -4 || 1, db = f.$SlideshowOptions, I = a.$Extend({
            $Class: p,
            $PlayInMode: 1,
            $PlayOutMode: 1
        }, f.$CaptionSliderOptions);
        I.$Transitions = I.$Transitions || I.$CaptionTransitions;
        var qb = f.$BulletNavigatorOptions, W = f.$ArrowNavigatorOptions, ab = f.$ThumbnailNavigatorOptions, Q = !f.$UISearchMode, y, v = a.$FindChild(q, "slides", Q), cb = a.$FindChild(q, "loading", Q) || a.$CreateDiv(e), Jb = a.$FindChild(q, "navigator", Q), cc = a.$FindChild(q, "arrowleft", Q), ac = a.$FindChild(q, "arrowright", Q), Hb = a.$FindChild(q, "thumbnavigator", Q), nc = a.$CssWidth(v), mc = a.$CssHeight(v), V, T = [], xc = a.$Children(v);
        ...
        var s = -1, yb, tb, r = T.length, K = f.$SlideWidth || nc, J = f.$SlideHeight || mc, Wb = f.$SlideSpacing, Bb = K + Wb, Cb = J + Wb, bc = gb & 1 ? Bb : Cb, u = b.min(f.$Cols, r), hb, x, L, Ab, S = [], Qb, Sb, Ob, dc, Fc, P, E = f.$PauseOnHover, pc = f.$AutoPlayInterval, Vb = f.$SlideDuration, rb, ub, fb, Rb = u < r, D = Rb ? f.$Loop : 0, Y, M, F = 1, O, B, R, vb = 0, wb = 0, H, bb, eb, Eb, w, U, z, Tb = new rc, Z, Lb = [];
        P = f.$AutoPlay;
        o.$Options = fc;
        jc();
        ...
        var xb = v, C = [], A, N, Fb = a.$Device(), jb = Fb.$Touchable, G, pb, Kb, sb;
    ...
    g.$JssorBulletNavigator$ = function (e, C) {
        ...
        f.$Options = d = a.$Extend({$SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1}, C);
    ...
    g.$JssorArrowNavigator$ = function (b, g, h) {
        ...
        d.$Options = f = a.$Extend({$Steps: 1}, h);
        k = f.$Steps;
        if (f.$Scale == i) {
    ...
    g.$JssorThumbnailNavigator$ = function (g, C) {
        var l = this, z, q, d, w = [], A, y, e, r, s, v, u, p, t, f, o;
        m.call(l);
        g = a.$GetElement(g);
        function B(m, f) {
            var g = this, b, k, i;
            ...
            function h(d) {
                if (d || !t.$LastDragSucceded()) {
                    var a = e - f % e, b = t.$GetVirtualIndex((f + a) / e - 1), c = b * e + e - a;
        ...
        l.$Reset = function (F, C) {
            if (!x) {
                ...
                q = -1;
                p = b.min(p, C.length);
                var j = d.$Orientation & 1, m = v + (v + r) * (e - 1) * (1 - j), l = u + (u + s) * (e - 1) * j, o = m + (m + r) * (p - 1) * j, n = l + (l + s) * (p - 1) * (1 - j);
                ...
                a.$Each(C, function (l, g) {
                    var h = new B(l, g), d = h.$Wrapper, c = b.floor(g / e), i = g % e;
    ...
    g.$JssorCaptionSlider$ = function (h, f, i) {
        ...
        function g(p, h, f) {
            var c = this, g, n = f ? h.$PlayInMode : h.$PlayOutMode, e = h.$Transitions, o = {
                $Transition: "t",
                $Delay: "d",
                $Duration: "du",
                x: "x",
            ...
            function m(w, c, z) {
                var g = {
                    ...
                    $During: c.$During,
                    $Reverse: f && !z
                }, m = w, r = a.$ParentNode(w), k = a.$CssWidth(m), j = a.$CssHeight(m), y = a.$CssWidth(r), x = a.$CssHeight(r), h = {}, e = {}, i = c.$ScaleClip || 1;
                ...
                if (c.$Zoom || c.$Rotate) {
                    ...
                    var s = {
                        ...
                        $Bottom: j,
                        $Left: 0
                    }, v = a.$Extend({}, s), d = v.$Offset = {}, u = c.$Clip & 4, p = c.$Clip & 8, t = c.$Clip & 1, q = c.$Clip & 2;
                    if (u && p) {
                        d.$Top = j / 2 * i;
                        d.$Bottom = -d.$Top
                    ...
                    if (t && q) {
                        d.$Left = k / 2 * i;
                        d.$Right = -d.$Left
                    } else if (t)d.$Right = -k * i; else if (q)d.$Left = k * i;
                    g.$Move = c.$Move;
                    e.$Clip = v;
                    h.$Clip = s
                }
    ...
    g.$JssorCaptionSlideo$ = function (n, g, m) {
        var b = this, o, h = {}, i = g.$Transitions, d = new l(0, 0);
        l.call(b, 0, 0);
        function j(d, c) {
            var b = {};
            a.$Each(d, function (d, f) {
                var e = h[f];
                if (e) {
                    if (a.$IsPlainObject(d))d = j(d, c || f == "e"); else if (c)if (a.$IsNumeric(d))d = o[d];
                    b[e] = d
                }
            });
            return b
        ...
        function k(e, c) {
            var b = [], d = a.$Children(e);
            a.$Each(d, function (d) {
                var h = a.$AttributeEx(d, "u") == "caption";
                if (h) {
                    var e = a.$AttributeEx(d, "t"), g = i[a.$ParseInt(e)] || i[e], f = {$Elmt: d, $Transition: g};
                    b.push(f)
                }
        ...
        function q(b) {
            a.$Each(b, function (e) {
                var b = e.$Elmt, d = a.$CssWidth(b), c = a.$CssHeight(b), f = {
                    $Left: a.$CssLeft(b),
                    $Top: a.$CssTop(b),
                    $Opacity: 1,
                    ...
                    $Width: d,
                    $Height: c,
                    $Clip: {$Top: 0, $Right: d, $Bottom: c, $Left: 0}
                };
                r(b, e.$Transition, f)
            })
        }
        ...
        function s(f) {
            var c = d.$GetPosition_OuterBegin(), e = 0;
        ...
        q(k(n, 1));
        d.$GoToPosition(-1);
        var p = g.$Breaks || [], e = [].concat(p[a.$ParseInt(a.$AttributeEx(n, "b"))] || []);
        e.push({b: d.$GetPosition_OuterEnd(), d: e.length ? 0 : m});
        s(e);
        b.$GoToPosition(-1)
    }
