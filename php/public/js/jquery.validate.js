...
$.extend( $.validator, {
	...
	defaults: {
		...
		onfocusin: function( element ) {
			!this.firstActive ? this.firstActive = element : '';
	...
	prototype: {
		...
		findFirstActive: function() {
			var firstActive = this.firstActive;
			return firstActive && $.grep( this.errorList, function( n ) {
				return n.element.name === firstActive.name;
			}).length === 1 && firstActive;
		},
