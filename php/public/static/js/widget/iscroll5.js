/*! iScroll v5.1.3 ~
 ...
 1.添加 zoom
 2.添加 probeType
 3.解决双层嵌套时，双击放大位置捕获触发位置出错的问题
 4.添加 beforeScrollEnd 事件；

 2016/02/16
 move事件添加了 stopMove 判断用于禁用拖动

 2016/03/02
 解决双层嵌套时，双指放大位置捕获触发位置出错的问题

 2016/04/05
 scrollCancel 增加 snap的判断

 2016/04/06
 click和tap事件判断 放在 scrollCancel以外
...
// INSERT POINT: _init
        ...
        _move: function (e) {
            ...
            if ( timestamp - this.endTime > 300 && (absDistX < 10 && absDistY < 10) /*&& !this.options.zoom*/ ) {
                return;
            }
        ...
        _end: function (e) {
            ...
            if ( !this.moved && this.options.tap ) {
                utils.tap(e, this.options.tap);
            }

            if ( !this.moved && this.options.click ) {
                utils.click(e);
            }
