...
@section('header_related')
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong><a href="{{ route('goods.B_feimai_list') }}" class="cur">非卖商品列表</a>|<a href="{{ route('goods.B_shangbin') }}">添加商品</a>|<a href="{{ route('goods.B_yimai_list') }}">已售商品列表</a>|
        ...
        <div class="IAMAIN_list">
            <div class="Goodslist">
                 <div class="GoodsLmain">
                     ...
                     <div class="GoodsML_head"><span style="float:left;">艺术软装</span> <span style=" color:#ff0000;">总库存：12件</span></div>
