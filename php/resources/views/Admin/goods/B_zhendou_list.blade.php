...
@section('header_related')
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong><a href="{{ route('goods.B_zhendou_list') }}" class="cur">甄豆商品列表</a>|<a href="{{ route('goods.B_shangbin') }}">添加商品</a>|<a href="{{ route('goods.B_yimai_list') }}">已售商品列表</a>|
        ...
        <div class="IAMAIN_list">
            <div class="Goodslist">
                 <div class="GoodsLmain">
                     ...
                     <div class="GoodsML_head"><font color="red" style="margin-right:5px;">105 甄豆</font>+<font color="red" style="margin-left:5px;">¥99.00</font><span>艺术软装</span> <span style=" color:#ff0000">总库存：12件</span></div>
