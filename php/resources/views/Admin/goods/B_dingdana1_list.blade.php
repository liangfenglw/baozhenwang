...
<link rel="stylesheet" href="{{ url('/css/style.css') }}" type="text/css">
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong><a href="{{ route('goods.B_dingdana1_list') }}" class="cur">订单列表</a>|<a href="{{ route('goods.B_dingdan_completelist') }}">已完成</a>|<a href="{{ route('goods.B_dingdan_deliverylist') }}">已发货</a>|<a href="{{ route('goods.B_dingdan_Nodeliverylist') }}">未发货</a>|<a href="{{ route('goods.B_dingdan_backlist') }}">退款订单</a>|</div>
                ...
                <form method="post" action="">
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr class="Alist_head">
                            ...
                            <th style="width: 150px;">购买总价</th>
                            <th style="width: 140px;">购买日期</th>
                        ...
                        <tr class="Alist_main">
                            ...
                            <td>直购系列</td>
                            <td>1171801173</td>
                            <td><font color="red">￥25220.0 + 甄豆5000</font></td>
                            <td>2017-07-19</td>
                            <td>安徽省-蚌埠市-禹会区</td>
                            <td>已完成</td>
                            <td>订单备注</td>
