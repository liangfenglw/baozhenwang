...
<link rel="stylesheet" href="{{ url('/css/style.css') }}" type="text/css">
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong><a href="{{ route('goods.B_dingdan_list') }}">订单列表</a>|<a href="{{ route('goods.B_dingdan_completelist') }}">已完成</a>|<a href="{{ route('goods.B_dingdan_deliverylist') }}"  class="cur">已发货</a>|<a href="{{ route('goods.B_dingdan_Nodeliverylist') }}">未发货</a>|<a href="{{ route('goods.B_dingdan_backlist') }}">退款订单</a>|</div>
                ...
                <form method="post" action="">
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr class="Alist_head">
                            ...
                            <th style="width: 130px;">购买日期</th>
                            <th style="width: 130px;">发货日期</th>
