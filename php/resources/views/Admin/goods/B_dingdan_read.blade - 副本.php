...
.dingdan_imgs img{ width: 90px; height: 90px; margin: 5px; float: left; }
    ...
    <div class="Iartice">
        ...
        <div class="IAMAIN" style=" width: 100%; height:auto; margin:0 25px; ">
            <form method="post" action="">
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                   	  <td width="29%" valign="top"><div class="dd_read_img">
                        <img src="{{url('/images/shengshilong.jpg')}} " ><p>装裱框：<font color="red">窄边黑 </font></p><p> 留白：<font color="red">无留白</font></p>
                      </div></td>
                      <td width="70%">
                                	...
                                	<table width="100%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr><!--定制订单显示-->
                                            ...
                                            <td colspan="3" class="dingdan_imgs">
                                                <img src="{{url('/images/shengshilong.jpg')}} " />
                                                <img src="{{url('/images/shengshilong.jpg')}} " />
                                                <img src="{{url('/images/shengshilong.jpg')}} " />
                                            </td>
                                        </tr>
