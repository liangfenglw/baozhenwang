...
<link rel="stylesheet" href="{{ url('/css/style.css') }}" type="text/css">
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong>
            <a href="{{ route('goods.B_dingdana3_list') }}" class="cur">订单列表</a>|
            <a href="{{ route('goods.B_dingdan_completelist') }}">已完成</a>|
            <a href="{{ route('goods.B_dingdan_deliverylist') }}">已发货</a>|
            <a href="{{ route('goods.B_dingdan_Nodeliverylist') }}">未发货</a>|
                ...
                <form method="post" action="">
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr class="Alist_head">
                            ...
                            <th style="width: 110px;">购买用户</th>
                            <th style="width: 100px;">购买总价</th>
                            <th style="width: 70px;">参拍人数</th>
