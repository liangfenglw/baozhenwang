...
<link rel="stylesheet" href="{{ url('/css/style.css') }}" type="text/css">
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong>
            ...
            <a href="{{ route('goods.B_dingdana2_completelist') }}">已完成</a>|
            <a href="{{ route('goods.B_dingdana2_deliverylist') }}">已发货</a>|
            <a href="{{ route('goods.B_dingdana2_Nodeliverylist') }}">未发货</a>|
            <a href="{{ route('goods.B_dingdan_rented') }}" class="cur">正租用</a>|
                ...
                <form method="post" action="">
                    <table width="100%" cellspacing="0" cellpadding="0">
                        <tr class="Alist_head">
                            ...
                            <th style="width: 130px;">租赁总价</th>
                            <th style="width: 100px;">租押金</th>
                            <th style="width: 130px;">租赁开始时间</th>
                            <th style="width: 130px;">租赁结束时间</th>
                        ...
                        <tr class="Alist_main">
                            ...
                            <td>租赁系列</td>
                            <td>1171801173</td>
                            <td><font color="red">￥99.00/1年</font></td>
