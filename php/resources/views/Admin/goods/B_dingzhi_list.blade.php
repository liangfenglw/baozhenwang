...
@section('header_related')
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">商品管理</strong><a href="{{ route('goods.B_yijia_list') }}" class="cur">定制商品列表</a>|<a href="{{ route('goods.B_shangbin') }}">添加商品</a>|<a href="{{ route('goods.B_yimai_list') }}">已售商品列表</a>|
