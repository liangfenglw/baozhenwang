...
<link rel="stylesheet" href="{{ url('/css/style.css') }}" type="text/css">
    ...
    <div class="Iartice">
        <div class="IAhead"><strong style="padding-right: 10px;">账户管理</strong><a href="{{ route('account.E_chongzhi') }}" class="cur">充值记录</a>|<a href="{{ route('account.E_consumption') }}">消费记录</a>|</div>
